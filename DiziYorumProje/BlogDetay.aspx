<%@ Page Title="" Language="C#" MasterPageFile="~/Kullanici.Master" AutoEventWireup="true" CodeBehind="BlogDetay.aspx.cs" Inherits="DiziYorumProje.WebForm1" %>
                ...
                <div class="col-md-8 single-main">
                    ...
                    <div class="content-form">
                        ...
                        <form runat="server">
                            ...
                            <asp:TextBox ID="TextBox3" runat="server" placeholder="Yorumunuz" Height="100px"></asp:TextBox>
